...
final class NotificationManager: ObservableObject {
    ...
    func requestPermissionIfNeeded() async {
        ...
        if authorizationStatus != .notDetermined {
            logger.info("Notification permission already determined: \(String(describing: self.authorizationStatus)) (\(self.authorizationStatus.rawValue))")
    ...
    private func updateAuthorizationStatus() async {
        ...
        logger.info("Authorization status updated: \(String(describing: self.authorizationStatus)) (\(self.authorizationStatus.rawValue))")
    }
